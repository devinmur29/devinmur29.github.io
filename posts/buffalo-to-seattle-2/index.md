---
title: "Driving from Buffalo NY to Seattle WA in 14 Days (Part 2)"
date: 2025-12-12
layout: post.html
permalink: "/posts/buffalo-to-seattle-2/"
summary: "Better late than never!!!"
---

I just finished my first quarter as a PhD student at [UW](https://www.ece.uw.edu/) so it's about time I get back to this!

### Day 8: Billings, MT to Pray, MT

I woke up excited to get the hell out of the Motel 6 I stayed in (number 2 of 3 across my whole trip) and make my way to Pray, MT, where I treated myself to a stay at [Chico Hot Springs](https://www.chicohotsprings.com/about) resort.


<figure class="image-row">
  <img src="./chico.JPEG" alt="Chico">
   <img src="./chico_room.JPEG" alt="Chico Room">
  <figcaption>SO CUTE SO COZY</figcaption>
</figure>
...
<figure class="image-row">
  <img src="./chico_drink.JPEG" alt="Cocktail">
   <img src="./chico_trout.JPEG" alt="Trout">
   <img src="./chico_filet.JPEG" alt="Filet">
   <img src="./chico_creme.JPEG" alt="Pumpkin">
  <figcaption>Easily the best meal I had on this trip</figcaption>
</figure>
...
<figure class="image-row">
  <img src="./towerfalls.JPEG" alt="Tower Falls">
   <img src="./towerfalls2.JPEG" alt="River">
   <img src="./bison_braut.JPEG" alt="Bison">
  <figcaption>Two views of the yellowstone river and a bison braut</figcaption>
</figure>
...
<figure class="image-row">
  <img src="./washburnsummit.JPEG" alt="Wasburn">
  <img src="./washburnsummit2.JPEG" alt="Wasburn">
  <figcaption>Spent probably 30 minutes chilling at the top</figcaption>
</figure>
...
<figure class="image-row">
  <img src="./brinkoflowerfalls.JPEG" alt="Canyon">
  <figcaption>l’appel du vide was strong with this one</figcaption>
</figure>
...
<figure class="image-row">
  <img src="./old_faithful.JPEG" alt="springs">
  <img src="./river.JPEG" alt="river">
  <img src="./hearts.JPEG" alt="hearts">
  <figcaption>Really feels like another planet at this spring</figcaption>
</figure>
...
<figure class="image-row">
  <img src="./idaho_falls.JPEG" alt="watertower">
  <img src="./idaho_falls_2.JPEG" alt="river">
  <figcaption>At the time of writing this I am envious of this sun</figcaption>
</figure>

I had a lot of free time this day so I did some work in a coffee shop before checking into my room and heading out for dinner. I loved dinner this night, [Thai food](https://share.google/MCuDgQFDSlTo1pZuf) with the biggest Thai Iced Tea I've ever seen.

<figure class="image-row">
  <img src="./giant_tea.JPEG" alt="Tea">
  <figcaption>If thai iced tea is on the menu I'm ordering it</figcaption>
</figure>
...
<figure class="image-row">
  <img src="./lava_tube.JPEG" alt="lava tube">
  <img src="./craters_1.JPEG" alt="lava 1">
  <img src="./craters_2.JPEG" alt="river">
  <img src="./craters_3.JPEG" alt="river">
  <figcaption>Lava rocks!</figcaption>
</figure>

There are some cool [legends originating from the Shoshone tribe](https://www.nps.gov/crmo/learn/historyculture/native-americans.htm) about this region, including one about a Great Serpent who tried to sleep on a giant mountain when lightning struck, angering it so much that is squeezed the mountain, melting the rock and causing the lava to flow. 
...
<figure class="image-row">
  <img src="./fried_chicken.JPEG" alt="lava">
  <figcaption></figcaption>
</figure>

### Day 13: Boise, ID to The Dalles, OR

Today was a long day of driving, and the only things I did before making it to The Dalles were stop at a cafe for [pastries](https://share.google/IOc7OV7qP6WQum4GG) in Baker City and do some work at the Baker City library.

<figure class="image-row">
  <img src="./pastries.JPEG" alt="Pastries">
  <figcaption>Breakfast lunch and dinner</figcaption>
</figure>
...
The last day of my drive! I decided to check out the [Multnomah Falls](https://share.google/iPzjGWnqG8ZLf0nBz), which were on the way to Seattle. Upon arriving, I felt like, ok, I'm really in the PNW now huh.
...
<figure class="image-row">
  ...
  <figcaption>I'm a big fan of this one, feels like something out of a fairy-tale woods</figcaption>
</figure>

I climbed to the top and back which took maybe 2 hours total, and finished my drive to Seattle!

<figure class="image-row">
  <img src="./Seattle.JPEG" alt="Seattle">
  <figcaption>My new home!</figcaption>
</figure>
