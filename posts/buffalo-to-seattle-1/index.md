---
title: "Driving from Buffalo NY to Seattle WA in 14 Days (Part 1)"
date: 2025-09-04
layout: post.html
permalink: "/posts/buffalo-to-seattle-1/"
...
1. Cities/Towns/Parks I haven't been to, and 
2. No more than 5 hours of driving a day
...
<div class="map-container">
  <iframe
    src="https://www.google.com/maps/d/u/0/embed?mid=1n6jeBMn8JYYTbI9CyFxrFwD4ewai3OU&ehbc=2E312F"
    allowfullscreen
    loading="lazy">
  </iframe>
</div>
...
<figure>
  <img src="./car_day1.JPEG" alt="car packed">
  <figcaption>Car packed on Day 1</figcaption>
</figure>

### Day 1: Buffalo, NY to Detroit, MI

I picked up the rental car from the Buffalo airport and drove it back home to pack up my things with my Mom. I was relieved to pick up the car without any problems because I rented from [Carrental8.com](https://www.carrental8.com/en-us), which somehow was over $500 cheaper than renting directly through Hertz.
...
My first stop in Detroit was the [River Walk](https://en.wikipedia.org/wiki/Detroit_International_Riverfront), which stretches for about 5.5 miles along the Detroit River. In 2021 it was voted best river walk in the US by USA Today readers, and I have to say it gave [The Esplanade](https://esplanade.org/) a run for its money. 

<figure>
  <img src="./riverwalk.JPEG" alt="riverwalk">
  <figcaption>Gorgeous Weather on Day 1!</figcaption>
</figure>

I'm not a big car person myself, but while visiting the Motor City I thought it would be appropriate to stop by [General Motors Headquarters](https://en.wikipedia.org/wiki/General_Motors) which happens to be right on the river walk. The outside of the building immediately made me think of [Bigweld Industries](https://fictionalcompanies.fandom.com/wiki/Bigweld_Industries) from the movie Robots.

<figure class="image-row">
  <img src="./generalmotors_outside.JPEG" alt="GM Outside">
  <img src="./bigweld.webp" alt="Bigweld Industries">
  <figcaption>Right? Right?</figcaption>
</figure>
...
<figure>
  <img src="./dunkin.JPEG" alt="Dunkin">
  <figcaption>My last $6 meal deal 🥲</figcaption>
</figure>
...
<figure class="image-row">
  <img src="./empty_lot_warren.JPEG" alt="empty lot">
  <img src="./empty_beach.JPEG" alt="empty beach">
  <figcaption>Seems like an underrated beach tbh</figcaption>
</figure>
...
<figure class="image-row">
  <img src="./dune1.JPEG" alt="Bottom of dune">
  <img src="./topofdune.JPEG" alt="Top of dune">
  <figcaption>The dune is much taller than it looks - left photo is from the bottom and right is from the top</figcaption>
</figure>
...
<figure>
  <img src="./joongboo.JPEG" alt="Dunkin">
  <figcaption>So much food 😋</figcaption>
</figure>
...
<figure class="image-row">
  <img src="./arboretum_trees_2.JPEG" alt="Shady arboretum">
  <img src="./arboretum_trees_4.JPEG" alt="Stubby tree">
  <img src="./arboretum_trees_3.JPEG" alt="Sunny Arboretum">
  <figcaption>Mosquitoes not pictured</figcaption>
</figure>
...
I then drove to the UW Madison campus to stop by the [Babcock Dairy Store](https://babcockdairystore.wisc.edu/), which is run by the Department of Animal and Dairy Sciences. I *think* the ice cream here is produced by a dairy plant on campus but I'm not sure I ever confirmed this. I panick ordered the Honey Mustard Pretzel flavor which was the first thing on the menu. It was a definitely a little weird but I could see folks with less of a sweet tooth enjoying it.

<figure class="image-row">
  <img src="./babcock_dairy.JPEG" alt="Babcock building">
  <img src="./honey_mustard.JPEG" alt="Ice cream">
  <figcaption>Definitely unique!</figcaption>
</figure>

Afterwards I walked along the main campus drive to get Russian Dumplings at [Paul's Pel'meni](https://paulspelmeni.com/), which you can douse with lots of different condiments for a very reasonable price.

<figure class="image-row">
  <img src="./campus_drive.JPEG" alt="Campus Drive">
  <img src="./dumplings.JPEG" alt="Dumplings">
  <figcaption>I think I'm listening to Kacey Musgrave's Golden Hour album here, which I can't believe I didn't give a full listen to until this trip</figcaption>
</figure>
...
<figure>
  <img src="./breakfast_madison.JPEG" alt="breakfast">
  <figcaption>The picture does not accurately capture my gratitude</figcaption>
</figure>
...
<figure class="image-row">
  <img src="./dells_store_1.JPEG" alt="Sneaky Pete">
  <img src="./dells_store_2.JPEG" alt="Ape">
  <img src="./dells_store_3.JPEG" alt="Ape">
  <figcaption>How do you get the name Sneaky Pete</figcaption>
</figure>
...
<figure class="image-row">
  <img src="./dells_river.JPEG" alt="River">
  <img src="./dells_river_2.JPEG" alt="River 2">
  <figcaption>Glaciers were responsible for so much of the scenery on the first legs of my trip</figcaption>
</figure>
...
<figure class="image-row">
  <img src="./quarry_path.JPEG" alt="quarry path">
  <img src="./quarry_water.JPEG" alt="Quarry Water">
  <figcaption>Views from Quarry 11</figcaption>
</figure>
...
<figure>
  ...
  <figcaption>This was like $15 total</figcaption>
</figure>
...
For lunch I went to [Fried's Family Restaraunt](https://share.google/dEI1em0FhJgiw5nWB), one of many restaraunts in Bismarck serving German dishes that the region is known for. I had the Knoephla soup (kind of like a clam chowder with chicken dumplings instead of clams) a Fleischkuekle (deep fried meat pie) and a Caramel Roll (basically a cinnamon roll?). Each was very delicious but also required a 30 minute power nap in the parking lot for digestion before continuing my drive. 

<figure class="image-row">
  <img src="./german_soup.JPEG" alt="Knoehpla">
   <img src="./german_lunch.JPEG" alt="Lunch">
  <figcaption>Pretty sure the remnants of this lunch can still be found in my arteries</figcaption>
</figure>

After my digestion nap I finished my drive to Wibaux, which felt very much like the middle of nowhere and had to be the [smallest town](https://share.google/B5AEuYiBvAhY3qOyo) I stayed in overnight during my trip.

### Day 7: Wibaux, MT to Billings, MT

On my way to Billings I decided to visit Montana's largest state park, [Makoshika State Park](https://share.google/HoA8pGNrL1eEt0Beh). I practically had the whole park to myself - I saw only park ranger vehicles from the time I drove in until the time I drove out.
...
<figure class="image-row">
  <img src="./makoshika_oil.JPEG" alt="oil">
   <img src="./makoshika_oil (2).JPEG" alt="Oil">
  <figcaption>If my interpretation of the signage is correct these golden-brown ridges are the stuff of oil?</figcaption>
</figure>
...
<figure class="image-row">
  <img src="./view_bottom_makoshika.JPEG" alt="Bottom view">
   <img src="./bridge_makoshka.JPEG" alt="bridge">
  <figcaption>Almost felt gluttonous having all these views to myself</figcaption>
</figure>
